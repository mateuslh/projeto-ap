...
|---|---:|---:|---:|---:|---|
| [Sala](r1/sala.md) | 3 | 1 | 1 | 1 | r1 |
| [Cozinha](r1/cozinha.md) | 4 | 1 | 1 | 2 | r1 |
| [Lavanderia](r1/lavanderia.md) | 2 | — | 2 | — | r1 |
| [Quarto de hóspede/filho](r1/hospede.md) | 1 | 1 | — | — | r1 |
| [Todos os cômodos](r1/geral.md) | 2 | 1 | — | 1 | r1 |
| **Total** | **12** | **4** | **4** | **4** | |

Os `spike`{ .t .t-spike } são o que ainda não virou decisão: quatro dos doze itens dependem de
um estudo antes de entrar no detalhamento. Os critérios de aceite de cada item são o
instrumento de acompanhamento — um item só se dá por atendido quando todos estiverem marcados.
